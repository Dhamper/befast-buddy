  ...
  return (
    <AppShell showSession={false}>
      <div className="mx-auto max-w-3xl space-y-6">
        <h1 className="title-light text-4xl sm:text-5xl">
          When did the symptoms start?
        </h1>
        <p className="text-white/85">
          Or when was the person last known to be completely normal? This is the
          one fact the hospital needs most — answer it before anything else.
        </p>
