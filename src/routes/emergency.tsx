  ...
  return (
    <AppShell>
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="rounded-[28px] border-2 border-alert-high bg-alert-high/25 p-7">
          <p className="eyebrow mb-3">Emergency action</p>
          <h1 className="display-xl text-4xl sm:text-5xl">Call {EMERGENCY.number} now</h1>
          <p className="mt-4 text-lg">
            {result.headline}. Say “possible stroke” and give the onset time.
          </p>
          <div className="mt-6">
            <EmergencyCallButton className="w-full justify-center py-6 text-2xl" />
          </div>
          <p className="mt-3 font-mono text-xs uppercase tracking-[0.16em]">
